...
func (lhc *LoginHistoryCreate) Save(ctx context.Context) (*LoginHistory, error) {
	...
	if len(lhc.hooks) == 0 {
		...
		if _, err := mut.Mutate(ctx, lhc.mutation); err != nil {
			return nil, err
		}
	}
	return node, err
...
func (lhc *LoginHistoryCreate) defaults() {
	if _, ok := lhc.mutation.CreateAt(); !ok {
		v := loginhistory.DefaultCreateAt()
		lhc.mutation.SetCreateAt(v)
	}
...
func (lhc *LoginHistoryCreate) check() error {
	if _, ok := lhc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`ent: missing required field "LoginHistory.app_id"`)}
	}
	if _, ok := lhc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "LoginHistory.user_id"`)}
	}
	if _, ok := lhc.mutation.ClientIP(); !ok {
		return &ValidationError{Name: "client_ip", err: errors.New(`ent: missing required field "LoginHistory.client_ip"`)}
	}
	if _, ok := lhc.mutation.UserAgent(); !ok {
		return &ValidationError{Name: "user_agent", err: errors.New(`ent: missing required field "LoginHistory.user_agent"`)}
	}
	if _, ok := lhc.mutation.CreateAt(); !ok {
		return &ValidationError{Name: "create_at", err: errors.New(`ent: missing required field "LoginHistory.create_at"`)}
	}
	return nil
}
...
func (u *LoginHistoryUpsert) UpdateCreateAt() *LoginHistoryUpsert {
	u.SetExcluded(loginhistory.FieldCreateAt)
	return u
}
...
// UpdateCreateAt sets the "create_at" field to the value that was provided on create.
func (u *LoginHistoryUpsertOne) UpdateCreateAt() *LoginHistoryUpsertOne {
	return u.Update(func(s *LoginHistoryUpsert) {
		s.UpdateCreateAt()
	})
}
...
// UpdateCreateAt sets the "create_at" field to the value that was provided on create.
func (u *LoginHistoryUpsertBulk) UpdateCreateAt() *LoginHistoryUpsertBulk {
	return u.Update(func(s *LoginHistoryUpsert) {
		s.UpdateCreateAt()
	})
}
